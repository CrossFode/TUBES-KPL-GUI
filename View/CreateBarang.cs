...
namespace View
{
    public partial class CreateBarang : Form
    {
        ...
        private void inputKodeBarang_TextChanged(object sender, EventArgs e)
        {

        }

        private void inputJumlahBarang_TextChanged(object sender, EventArgs e)
        {

        }

        private void inputHargaBarang_TextChanged(object sender, EventArgs e)
        {
